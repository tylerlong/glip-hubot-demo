...
glip-hubot-demo is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running glip-hubot-demo Locally
...
1. should not hard-code "hubot" in the repeat script. Because its name could be something else.
